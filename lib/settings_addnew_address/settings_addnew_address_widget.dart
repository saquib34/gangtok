...
import 'settings_addnew_address_model.dart';
export 'settings_addnew_address_model.dart';

class SettingsAddnewAddressWidget extends StatefulWidget {
  const SettingsAddnewAddressWidget({super.key});

  @override
  State<SettingsAddnewAddressWidget> createState() =>
      _SettingsAddnewAddressWidgetState();
}

class _SettingsAddnewAddressWidgetState
    extends State<SettingsAddnewAddressWidget> {
  late SettingsAddnewAddressModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SettingsAddnewAddressModel());
