    ...
    return FutureBuilder<int>(
      future: queryInventoryRecordCount(
        queryBuilder: (inventoryRecord) => inventoryRecord.where(
          'categories',
          isEqualTo: FFAppState().allTestcategory,
        ),
      ),
                            ...
                            Flexible(
                              child: Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    0.0, 0.0, 8.0, 0.0),
                                child: Text(
                                  '${FFAppState().allTestcategory}(${specificCategoriesCount.toString()})',
                                                    ...
                                                    ClipRRect(
                                                      ...
                                                      child: Image.network(
                                                        valueOrDefault<String>(
                                                          listViewInventoryRecord
                                                              .inventoryImage,
                                                          'https://icon2.cleanpng.com/20210428/wgc/transparent-nature-icon-portrait-icon-landscape-inside-frame-i-60898d2a9d13e6.1989383116196273066434.jpg',
                                                        ),
                                                        width: double.infinity,
                                                        height: 220.0,
                                                        fit: BoxFit.contain,
